...
def build():
    ...
    info(" adminPc-vlan: 10-ip: 10.0.10.11")
         info(" registrar-vlan: 20- ip: 10.0.20.10")
         info(" hod1-vlan: 20-ip: 10.0.20.11")
         info(" staff1-vlan: 20-ip: 10.0.20.12")
         info(" student1-vlan: 40-ip: 10.0.40.11")
         info(" lab3-vlan: 30-ip: 10.0.30.13")
         info(" lab1-ip: 10.0.30.11")
         info(" lab2-vlan: 30-ip: 10.0.30.12")
         info(" lab4-vlan: 30-ip: 10.0.30.14")
         info(" adminSvr-vlan: 10-ip: 10.0.10.10") 
         info(" lib1-vlan: 50-ip: 10.0.50.11")
         info(" lib2-vlan: 50-ip: 10.0.50.12")
         info(" student2-vlan: 40-ip: 10.0.40.12")
         info(" librarySvr-vlan: 50-ip: 10.0.50.20")
         info(" b_admin-vlan: 60-ip: 10.0.60.11")
         info(" b_lab1-vlan: 70-ip: 10.0.70.11")
         info(" b_stu2-vlan: 80-ip: 10.0.80.12")
         info(" b_staff-vlan: 60-ip: 10.0.60.12")
         info(" b_lab2-vlan: 70-ip: 10.0.70.12")
        info("  b_stu1-vlan: 80-ip: 10.0.80.11")
    info("  Useful tests:\n")
