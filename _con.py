...
PORT_VLAN = {
    ...
    # switches represent real buildings or wiring closets. VLANs are
    # present only where a real campus would need them, not on every switch.
    1: {1:TRUNK, 2:TRUNK, 3:TRUNK, 4:TRUNK, 5:TRUNK},
    2: {1:TRUNK, 2:10, 3:20},
    3: {1:TRUNK, 2:20, 3:20, 4:40, 5:30, 6:50},
    4: {1:TRUNK, 2:30, 3:30, 4:30},
    5: {1:TRUNK, 2:10, 3:50, 4:40, 5:50},
    # s6 is the city campus aggregation switch. City access VLANs are
    # shared only across the two city buildings where they are needed.
    6: {1:TRUNK, 2:TRUNK, 3:TRUNK},
    7: {1:TRUNK, 2:60, 3:70, 4:80},
    8: {1:TRUNK, 2:60, 3:70, 4:80},
}
...
def vlan_gateway_ip(vlan_id):
    ...
    if not prefix:
        return None
    gateway_host = "254" if vlan_id in CITY_VLANS else "1"
    return prefix + gateway_host
  ...
  <main>
    ...
    <div class="page active" id="page-dashboard">
      ...
      <div class="card">
        ...
        <table>
          <thead><tr><th>VLAN</th><th>Name</th><th>Subnet</th><th>Gateway</th><th>Status</th></tr></thead>
...
<script>
const VLANS = [
  {id:10,name:"Main Admin",         subnet:"10.0.10.0/24", gateway:"10.0.10.1"},
  {id:20,name:"Faculty & Staff",    subnet:"10.0.20.0/24", gateway:"10.0.20.1"},
  {id:30,name:"Teaching Labs",      subnet:"10.0.30.0/24", gateway:"10.0.30.1"},
  {id:40,name:"Student WiFi",       subnet:"10.0.40.0/24", gateway:"10.0.40.1"},
  {id:50,name:"Library & Servers",  subnet:"10.0.50.0/24", gateway:"10.0.50.1"},
  {id:60,name:"City Admin",         subnet:"10.0.60.0/24", gateway:"10.0.60.254"},
  {id:70,name:"City Labs",          subnet:"10.0.70.0/24", gateway:"10.0.70.254"},
  {id:80,name:"City Student WiFi",  subnet:"10.0.80.0/24", gateway:"10.0.80.254"},
];
...
function renderDashboard(){
  ...
  document.getElementById('vlan-table').innerHTML=VLANS.map(v=>`<tr>
    ...
    <td class="mono" style="color:var(--muted)">${v.gateway}</td>
