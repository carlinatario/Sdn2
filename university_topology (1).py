...
def build():
    ...
    s1  = net.addSwitch("s1",  dpid="0000000000000001", **switch_opts)
    s2  = net.addSwitch("s2",  dpid="0000000000000002", **switch_opts)
    s3  = net.addSwitch("s3",  dpid="0000000000000003", **switch_opts)
    s4  = net.addSwitch("s4",  dpid="0000000000000004", **switch_opts)
    s5  = net.addSwitch("s5",  dpid="0000000000000005", **switch_opts)
    s6  = net.addSwitch("s6",  dpid="0000000000000006", **switch_opts)
    s7  = net.addSwitch("s7",  dpid="0000000000000007", **switch_opts)
    s8  = net.addSwitch("s8",  dpid="0000000000000008", **switch_opts)
    s9  = net.addSwitch("s9",  dpid="0000000000000009", **switch_opts)
    s10 = net.addSwitch("s10", dpid="000000000000000a", **switch_opts)
    s11 = net.addSwitch("s11", dpid="000000000000000b", **switch_opts)
    s12 = net.addSwitch("s12", dpid="000000000000000c", **switch_opts)
    s13 = net.addSwitch("s13", dpid="000000000000000d", **switch_opts)
    s14 = net.addSwitch("s14", dpid="000000000000000e", **switch_opts)
    s15 = net.addSwitch("s15", dpid="000000000000000f", **switch_opts)
    s16 = net.addSwitch("s16", dpid="0000000000000010", **switch_opts)
