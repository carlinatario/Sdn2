...
VLAN_NAMES = {
    10: "Admin Office A", 20: "HOD & Staff",
    30: "Computer Lab A", 40: "Student WiFi A",
    50: "Library",        60: "Admin Office B",
    70: "Computer Lab B", 80: "Student WiFi B",
}
...
class UniversityController(app_manager.RyuApp):
    ...
    def apply_acl_realtime(self, src_vlan, dst_vlan, allow):
        ...
        self._delete_flows_for_vlan_pair(src_vlan, dst_vlan)
        if not allow:
            # Install a permanent drop entry so future packets are blocked
            # at line rate without hitting the controller.
